...
PATH_TO_CKPT = MODEL_NAME + '/frozen_inference_graph2.pb'
...
# cap = cv2.VideoCapture('/home/seth/Videos/drone4.mp4')
...
with detection_graph.as_default():
  with tf.Session(graph=detection_graph) as sess:
    ...
    while cap.isOpened():
        ...
        image_np = frame[0:720, 0:1280] # for using only the left camera feed if using ZED as input
        ...
        cv2.imshow('object detection 1', cv2.resize(image_np, (1280, 720)))
